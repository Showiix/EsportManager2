...
pub fn get_team_players(team_short_name: &str) -> Vec<PlayerConfig> {
    match team_short_name {
        ...
        "JDG" => vec![
            ...
            PlayerConfig { game_id: "Ruler", real_name: Some("朴载赫"), nationality: "KR", position: Position::Adc, age: 27, ability: 69, potential: 69, is_starter: true, traits: &[TraitType::Consistent, TraitType::Veteran, TraitType::TeamLeader, TraitType::Resilient] },
        ...
        "WBG" => vec![
            PlayerConfig { game_id: "TheShy", real_name: Some("姜承録"), nationality: "KR", position: Position::Top, age: 27, ability: 69, potential: 69, is_starter: true, traits: &[TraitType::Explosive, TraitType::Volatile, TraitType::Veteran, TraitType::GlassCannon] },
        ...
        "RNG" => vec![
            ...
            PlayerConfig { game_id: "Ming", real_name: Some("史森明"), nationality: "CN", position: Position::Sup, age: 27, ability: 67, potential: 67, is_starter: true, traits: &[TraitType::TeamLeader, TraitType::Veteran, TraitType::Resilient] },
        ],
        "FPX" => vec![
        ...
        "LNG" => vec![
            ...
            PlayerConfig { game_id: "Tarzan", real_name: Some("李承勇"), nationality: "KR", position: Position::Jug, age: 26, ability: 68, potential: 68, is_starter: true, traits: &[TraitType::Consistent, TraitType::Ironman, TraitType::Veteran, TraitType::Resilient] },
        ...
        "IG" => vec![
            ...
            PlayerConfig { game_id: "Rookie", real_name: Some("宋义进"), nationality: "KR", position: Position::Mid, age: 28, ability: 69, potential: 69, is_starter: true, traits: &[TraitType::Clutch, TraitType::Veteran, TraitType::TeamLeader, TraitType::LateBlocker] },
        ...
        "T1" => vec![
            ...
            PlayerConfig { game_id: "Faker", real_name: Some("李相赫"), nationality: "KR", position: Position::Mid, age: 28, ability: 72, potential: 72, is_starter: true, traits: &[TraitType::Clutch, TraitType::MentalFortress, TraitType::TeamLeader, TraitType::Veteran, TraitType::Resilient] },
        ...
        "DRX" => vec![
            ...
            PlayerConfig { game_id: "Deft", real_name: Some("金赫奎"), nationality: "KR", position: Position::Adc, age: 28, ability: 67, potential: 67, is_starter: true, traits: &[TraitType::Veteran, TraitType::Consistent, TraitType::Clutch, TraitType::Resilient] },
        ...
        "LZ" => vec![
            ...
            PlayerConfig { game_id: "PraY", real_name: Some("金钟仁"), nationality: "KR", position: Position::Adc, age: 29, ability: 67, potential: 67, is_starter: true, traits: &[TraitType::Veteran, TraitType::Consistent, TraitType::LateBlocker] },
        ...
        "HLE" => vec![
            ...
            PlayerConfig { game_id: "Mireu", real_name: Some("朴承焕"), nationality: "KR", position: Position::Mid, age: 20, ability: 69, potential: 73, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Clutch, TraitType::Prodigy] },
        ...
        "AF" => vec![
            ...
            PlayerConfig { game_id: "Leo", real_name: Some("韩坚熙"), nationality: "KR", position: Position::Adc, age: 20, ability: 65, potential: 70, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Prodigy] },
        ...
        "TH" => vec![
            ...
            PlayerConfig { game_id: "Jankos", real_name: Some("乔纳斯·温尼克"), nationality: "PL", position: Position::Jug, age: 29, ability: 67, potential: 67, is_starter: true, traits: &[TraitType::Veteran, TraitType::TeamLeader, TraitType::Clutch, TraitType::LateBlocker] },
        ...
        "G2" => vec![
            ...
            PlayerConfig { game_id: "Caps", real_name: Some("鲁卡斯·哈斯廷斯"), nationality: "DK", position: Position::Mid, age: 25, ability: 69, potential: 71, is_starter: true, traits: &[TraitType::Clutch, TraitType::Explosive, TraitType::TeamLeader, TraitType::GlassCannon] },
        ...
        "100T" => vec![
            ...
            PlayerConfig { game_id: "Doublelift", real_name: Some("彼得·卢"), nationality: "US", position: Position::Adc, age: 31, ability: 67, potential: 67, is_starter: true, traits: &[TraitType::Veteran, TraitType::Clutch, TraitType::TeamLeader, TraitType::LateBlocker] },
        ...
        "C9" => vec![
            ...
            PlayerConfig { game_id: "Berserker", real_name: Some("金敏宇"), nationality: "KR", position: Position::Adc, age: 20, ability: 68, potential: 72, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Explosive, TraitType::Prodigy] },
        ...
        "TL" => vec![
            ...
            PlayerConfig { game_id: "Yeon", real_name: Some("延尚赫"), nationality: "KR", position: Position::Adc, age: 20, ability: 67, potential: 71, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Prodigy] },
            PlayerConfig { game_id: "CoreJJ", real_name: Some("乔伊·赵"), nationality: "KR", position: Position::Sup, age: 29, ability: 68, potential: 68, is_starter: true, traits: &[TraitType::Veteran, TraitType::TeamLeader, TraitType::Consistent, TraitType::LateBlocker] },
        ],
        "NRG" => vec![
        ...
        "DIG" => vec![
            ...
            PlayerConfig { game_id: "Kenvi", real_name: Some("肯·维加"), nationality: "US", position: Position::Jug, age: 20, ability: 64, potential: 68, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Prodigy] },
        ...
        "EG" => vec![
            PlayerConfig { game_id: "Jojopyun", real_name: Some("乔乔·朴"), nationality: "CA", position: Position::Top, age: 19, ability: 66, potential: 71, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Clutch, TraitType::Prodigy] },
            ...
            PlayerConfig { game_id: "Danny", real_name: Some("丹尼·金"), nationality: "US", position: Position::Mid, age: 20, ability: 67, potential: 72, is_starter: true, traits: &[TraitType::RisingStar, TraitType::Explosive, TraitType::Prodigy] },
        ...
        "TSM" => vec![
            PlayerConfig { game_id: "Huni", real_name: Some("海尼·海沃德"), nationality: "KR", position: Position::Top, age: 27, ability: 65, potential: 65, is_starter: true, traits: &[TraitType::Volatile, TraitType::Veteran, TraitType::GlassCannon] },
