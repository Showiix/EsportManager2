...
const regionTeamsData: Record<string, any[]> = {
  LPL: [
    { id: 1, name: 'JD Gaming', short: 'JDG', region: 'LPL', wins: 14, losses: 2, points: 42 },
    { id: 2, name: 'Bilibili Gaming', short: 'BLG', region: 'LPL', wins: 13, losses: 3, points: 39 },
    { id: 3, name: 'Top Esports', short: 'TES', region: 'LPL', wins: 12, losses: 4, points: 36 },
    { id: 4, name: 'Weibo Gaming', short: 'WBG', region: 'LPL', wins: 11, losses: 5, points: 33 },
    { id: 5, name: 'LNG Esports', short: 'LNG', region: 'LPL', wins: 10, losses: 6, points: 30 },
    { id: 6, name: 'EDward Gaming', short: 'EDG', region: 'LPL', wins: 9, losses: 7, points: 27 },
    { id: 7, name: 'FunPlus Phoenix', short: 'FPX', region: 'LPL', wins: 8, losses: 8, points: 24 },
    { id: 8, name: 'Royal Never Give Up', short: 'RNG', region: 'LPL', wins: 7, losses: 9, points: 21 },
    { id: 9, name: 'Invictus Gaming', short: 'IG', region: 'LPL', wins: 6, losses: 10, points: 18 },
    { id: 10, name: 'Oh My God', short: 'OMG', region: 'LPL', wins: 5, losses: 11, points: 15 },
    ...
    { id: 13, name: 'Anyone Legend', short: 'AL', region: 'LPL', wins: 2, losses: 14, points: 6 },
    { id: 14, name: 'ThunderTalk Gaming', short: 'TT', region: 'LPL', wins: 1, losses: 15, points: 3 },
  ],
  LCK: [
    { id: 101, name: 'T1', short: 'T1', region: 'LCK', wins: 15, losses: 1, points: 45 },
    { id: 102, name: 'Gen.G', short: 'GEN', region: 'LCK', wins: 14, losses: 2, points: 42 },
    { id: 103, name: 'Dplus KIA', short: 'DK', region: 'LCK', wins: 12, losses: 4, points: 36 },
    { id: 104, name: 'Hanwha Life', short: 'HLE', region: 'LCK', wins: 11, losses: 5, points: 33 },
    { id: 105, name: 'KT Rolster', short: 'KT', region: 'LCK', wins: 10, losses: 6, points: 30 },
    { id: 106, name: 'DRX', short: 'DRX', region: 'LCK', wins: 9, losses: 7, points: 27 },
    { id: 107, name: 'Kwangdong Freecs', short: 'KDF', region: 'LCK', wins: 8, losses: 8, points: 24 },
    { id: 108, name: 'Nongshim RedForce', short: 'NS', region: 'LCK', wins: 7, losses: 9, points: 21 },
    { id: 109, name: 'Liiv SANDBOX', short: 'LSB', region: 'LCK', wins: 6, losses: 10, points: 18 },
    { id: 110, name: 'BNK FearX', short: 'FOX', region: 'LCK', wins: 5, losses: 11, points: 15 },
    { id: 111, name: 'OKSavingsBank BRION', short: 'BRO', region: 'LCK', wins: 4, losses: 12, points: 12 },
    { id: 112, name: 'Fredit BRION', short: 'FB', region: 'LCK', wins: 3, losses: 13, points: 9 },
    { id: 113, name: 'DN Freecs', short: 'DNF', region: 'LCK', wins: 2, losses: 14, points: 6 },
    { id: 114, name: 'Daejon Stars', short: 'DJS', region: 'LCK', wins: 1, losses: 15, points: 3 },
  ],
  LEC: [
    { id: 201, name: 'G2 Esports', short: 'G2', region: 'LEC', wins: 14, losses: 2, points: 42 },
    { id: 202, name: 'Fnatic', short: 'FNC', region: 'LEC', wins: 13, losses: 3, points: 39 },
    { id: 203, name: 'MAD Lions', short: 'MAD', region: 'LEC', wins: 12, losses: 4, points: 36 },
    { id: 204, name: 'Team Vitality', short: 'VIT', region: 'LEC', wins: 11, losses: 5, points: 33 },
    ...
    { id: 211, name: 'Giants Gaming', short: 'GIA', region: 'LEC', wins: 4, losses: 12, points: 12 },
    { id: 212, name: 'Karmine Corp', short: 'KC', region: 'LEC', wins: 3, losses: 13, points: 9 },
  ...
  LCS: [
    { id: 301, name: 'Cloud9', short: 'C9', region: 'LCS', wins: 14, losses: 2, points: 42 },
    { id: 302, name: 'Team Liquid', short: 'TL', region: 'LCS', wins: 13, losses: 3, points: 39 },
    { id: 303, name: '100 Thieves', short: '100T', region: 'LCS', wins: 12, losses: 4, points: 36 },
    { id: 304, name: 'FlyQuest', short: 'FLY', region: 'LCS', wins: 11, losses: 5, points: 33 },
    ...
    for (let i = 0; i < shuffledTeams.length - 1; i += 2) {
      if (i + 1 < shuffledTeams.length) {
        ...
        if (week < 5) {
          ...
          homeScore = homeWin ? 2 : Math.floor(Math.random() * 2)
          awayScore = homeWin ? Math.floor(Math.random() * 2) : 2
          winnerId = homeWin ? homeTeam.id : awayTeam.id
        } else if (week === 5) {
          status = 'active'
        }
  ...
  matchDetail.games.forEach(game => {
    game.teamAPlayers.forEach(perf => {
      playerStore.recordPerformance(
        perf.playerId,
        perf.playerName,
        String(match.homeTeamId || match.homeTeam),
        perf.position,
        perf.impactScore,
        perf.actualAbility,
    ...
    game.teamBPlayers.forEach(perf => {
      playerStore.recordPerformance(
        perf.playerId,
        perf.playerName,
        String(match.awayTeamId || match.awayTeam),
        perf.position,
        perf.impactScore,
        perf.actualAbility,
        String(gameStore.currentSeason),
...
const simulateAll = async () => {
  ...
  for (const match of pendingMatches) {
    ...
    const homeWin = Math.random() > 0.5
    match.homeScore = homeWin ? 2 : Math.floor(Math.random() * 2)
    match.awayScore = homeWin ? Math.floor(Math.random() * 2) : 2
    match.winnerId = homeWin ? match.homeTeamId : match.awayTeamId
    match.status = 'completed'
  }
...
const simulatePlayoffs = async () => {
  ...
  const simulateMatch = (match: any) => {
    const teamAWin = Math.random() > 0.5
    match.scoreA = teamAWin ? 3 : Math.floor(Math.random() * 3)
    match.scoreB = teamAWin ? Math.floor(Math.random() * 3) : 3
    match.winnerId = teamAWin ? match.teamAId : match.teamBId
    match.status = 'completed'
    return teamAWin
  }
  ...
  simulateMatch(w1Match1)
  simulateMatch(w1Match2)
  ...
  simulateMatch(l1Match1)
  simulateMatch(l1Match2)
  ...
  simulateMatch(finalMatch.value)
