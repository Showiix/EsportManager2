...
| 系统 | 文档 | 核心文件 |
|------|------|----------|
| 时间推进 | [time-system.md](./03-core-systems/time-system.md) | `services/game_flow/` |
...
| 转会系统 | [transfer-system.md](./03-core-systems/transfer-system.md) | `engines/transfer/` |
| 转会窗口关闭 | [transfer-window-close.md](./03-core-systems/transfer-window-close.md) | `engines/transfer/` |
| 竞价分析 | [transfer-bid-analysis.md](./03-core-systems/transfer-bid-analysis.md) | `engines/transfer/` |
